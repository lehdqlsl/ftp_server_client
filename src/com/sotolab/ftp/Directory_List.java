...
public class Directory_List extends Activity implements AdapterView.OnItemClickListener, OnClickListener {
	...
	public void getDir(String dirPath) {
		...
		lv.setAdapter(new ArrayAdapter<String>(this, android.R.layout.simple_list_item_activated_1, item));
	}
	...
	public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
		...
		if (file.canRead())
			...
			new AlertDialog.Builder(this).setIcon(R.drawable.pay_48)
